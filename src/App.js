...
const euroValues = [
  ...
  { label: "10 Cent", value: 0.10, color: "#d4af37", shape: "circle", radius: 30 }, // Gold
  { label: "20 Cent", value: 0.20, color: "#d4af37", shape: "circle", radius: 35 }, // Gold
  { label: "50 Cent", value: 0.50, color: "#d4af37", shape: "circle", radius: 40 }, // Gold
  { label: "1 Euro", value: 1.00, color: "#c0c0c0", shape: "circle", radius: 40 }, // Silber mit Goldrand
  { label: "2 Euro", value: 2.00, color: "#c0c0c0", shape: "circle", radius: 45 }, // Silber mit Goldrand
  ...
  return (
    <div style={{ padding: "10px", textAlign: "center" }}>
      ...
      >
        ...
        <p style={{ fontSize: "12px" }}>Erledigte Aufgaben: {tasksCompleted}</p>
        <p style={{ fontSize: "12px" }}>Richtig erledigte Aufgaben: {tasksCorrect}</p>
      </div>
    </div>
  );
};
